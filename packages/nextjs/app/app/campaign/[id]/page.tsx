...
export default function CampaignDetailPage() {
  ...
  const [ngoAddress, title, targetAmount, amountRaised, fundsReleased, nextMilestoneIndex, completed, impactNftCounter] =
    campaignInfo;
          ...
          <div className="mt-6">
            <div className="flex justify-between text-lg mb-2">
              ...
              <span className="text-base-content/60">
                of {parseFloat(campaign.targetAmount).toFixed(4)} ETH
              </span>
            </div>
            <progress className="progress progress-primary w-full h-4" value={progress} max="100" />
          ...
          <div className="stats stats-vertical lg:stats-horizontal shadow mt-6">
            ...
            <div className="stat">
              ...
              <div className="stat-value text-2xl">
                {campaign.nextMilestoneIndex + 1}/{milestones.length}
              </div>
            </div>
            <div className="stat">
                  ...
                  <li key={index}>
                    <div className="timeline-start timeline-box">
                      ...
                      <div className="badge badge-outline">
                        {parseFloat(milestone.requiredAmount).toFixed(4)} ETH
                      </div>
                    </div>
                    <div className="timeline-middle">
                      {/* SVG icons preserved unchanged */}
                    </div>
                    <div className="timeline-end">
                      {milestone.proofUri && (
                        <a
                          href={
                            milestone.proofUri.startsWith("http")
                              ? milestone.proofUri
                              : `https://ipfs.io/ipfs/${milestone.proofUri}`
                          }
                          target="_blank"
                ...
                <>
                  ...
                  <div className="alert alert-info mt-4">
                    ...
                    <span className="text-xs">
                      You&apos;ll receive a Proof-of-Impact NFT for your contribution!
                    </span>
                  </div>
                </>
              ) : (
