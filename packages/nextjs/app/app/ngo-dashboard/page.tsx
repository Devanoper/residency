...
export default function NGODashboard() {
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex flex-col justify-center items-center p-8 gap-4">
          ...
          <span className="text-sm text-base-content/40">
            Total campaigns to check: {nextCampaignId ? Number(nextCampaignId) - 1 : 0}
          </span>
        </div>
      </div>
    );
        ...
        <div className="alert alert-info">
          ...
          <div>
            ...
            <p className="text-sm mt-2">
              Make sure you are connected with the correct wallet that was used when creating the campaign.
            </p>
          </div>
        </div>
      </div>
  ...
  const currentMilestone =
    milestonesData && selectedCampaignInfo
      ? {
              ...
              <div className="space-y-2">
                {myCampaigns.map(campaign => (
                  ...
                  >
                    ...
                    {campaign.completed && <div className="badge badge-success badge-sm">✓</div>}
                  </button>
                ))}
              </div>
            </div>
          ...
          {selectedCampaignInfo && currentMilestone && (
            <>
              <div className="card bg-base-100 shadow-xl mb-6">
                <div className="card-body">
                  <h2 className="card-title">{myCampaigns.find(c => c.id === selectedCampaignId)?.title}</h2>
                        ...
                        <div className="form-control w-full">
                          ...
                          <label className="label">
                            <span className="label-text-alt">
                              Upload your proof documents to IPFS and paste the hash or link here
                            </span>
                          </label>
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-base-content/70">
                          Collect receipts, photos, invoices, or documents proving milestone completion
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside ml-4 mt-1 text-base-content/60">
                          ...
                          <li>
                            <a href="https://nft.storage" target="_blank" rel="noopener noreferrer" className="link">
                              NFT.Storage
                            </a>
                          </li>
                          <li>
                            <a href="https://web3.storage" target="_blank" rel="noopener noreferrer" className="link">
                              Web3.Storage
                            </a>
                          </li>
                        </ul>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-base-content/70">
                          It will look like: <code className="bg-base-200 px-2 py-1 rounded">QmXxxx...</code>
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
