    ...
    const fetchPendingVerifications = async () => {
      ...
      try {
        ...
        results.forEach(([infoData, milestonesData], index) => {
          ...
          const [ngoAddress, title, , amountRaised, fundsReleased, nextMilestoneIndex, completed] = infoData as any;
          const [descriptions, requiredAmounts, isProofSubmittedArray, isVerifiedArray, proofUris] =
            milestonesData as any;
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-base-content/70">
                  Carefully examine all uploaded documentation (receipts, photos, reports)
                </p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-base-content/70">
                  Ensure the work described in the milestone has been completed as specified
                </p>
              </div>
            </div>
            <div className="flex gap-3">
      ...
      <div className="card-body">
        <div className="flex justify-between items-start">
          <div className="flex-1">
            ...
            {/* Proof Preview */}
            <div className="mb-3">
              <button className="btn btn-sm btn-ghost" onClick={() => setShowProof(!showProof)}>
